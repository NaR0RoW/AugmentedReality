...
: ${AMENT_CURRENT_PREFIX:="/home/she/ohhhhh/video_our/src/cpp/install/cpp"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cpp/environment/library_path.sh"
